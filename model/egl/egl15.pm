...
module partyA
	...
	[receiveA] phase=1 & n=0  -> 0.5 : (b0'=L)  + 0.5 : (b15'=L);
	[receiveA] phase=1 & n=1  -> 0.5 : (b1'=L)  + 0.5 : (b16'=L);
	[receiveA] phase=1 & n=2  -> 0.5 : (b2'=L)  + 0.5 : (b17'=L);
	[receiveA] phase=1 & n=3  -> 0.5 : (b3'=L)  + 0.5 : (b18'=L);
	[receiveA] phase=1 & n=4  -> 0.5 : (b4'=L)  + 0.5 : (b19'=L);
	[receiveA] phase=1 & n=5  -> 0.5 : (b5'=L)  + 0.5 : (b20'=L);
	[receiveA] phase=1 & n=6  -> 0.5 : (b6'=L)  + 0.5 : (b21'=L);
	[receiveA] phase=1 & n=7  -> 0.5 : (b7'=L)  + 0.5 : (b22'=L);
	[receiveA] phase=1 & n=8  -> 0.5 : (b8'=L)  + 0.5 : (b23'=L);
	[receiveA] phase=1 & n=9  -> 0.5 : (b9'=L)  + 0.5 : (b24'=L);
	[receiveA] phase=1 & n=10 -> 0.5 : (b10'=L) + 0.5 : (b25'=L);
	[receiveA] phase=1 & n=11 -> 0.5 : (b11'=L) + 0.5 : (b26'=L);
	[receiveA] phase=1 & n=12 -> 0.5 : (b12'=L) + 0.5 : (b27'=L);
	[receiveA] phase=1 & n=13 -> 0.5 : (b13'=L) + 0.5 : (b28'=L);
	[receiveA] phase=1 & n=14 -> 0.5 : (b14'=L) + 0.5 : (b29'=L);
	...
	[receiveA] phase=3 & n=0  -> (b15'=min(b15+1,L));
	[receiveA] phase=3 & n=1  -> (b16'=min(b16+1,L));
	[receiveA] phase=3 & n=2  -> (b17'=min(b17+1,L));
	[receiveA] phase=3 & n=3  -> (b18'=min(b18+1,L));
	[receiveA] phase=3 & n=4  -> (b19'=min(b19+1,L));
	[receiveA] phase=3 & n=5  -> (b20'=min(b20+1,L));
	[receiveA] phase=3 & n=6  -> (b21'=min(b21+1,L));
	[receiveA] phase=3 & n=7  -> (b22'=min(b22+1,L));
	[receiveA] phase=3 & n=8  -> (b23'=min(b23+1,L));
	[receiveA] phase=3 & n=9  -> (b24'=min(b24+1,L));
	[receiveA] phase=3 & n=10 -> (b25'=min(b25+1,L));
	[receiveA] phase=3 & n=11 -> (b26'=min(b26+1,L));
	[receiveA] phase=3 & n=12 -> (b27'=min(b27+1,L));
	[receiveA] phase=3 & n=13 -> (b28'=min(b28+1,L));
	[receiveA] phase=3 & n=14 -> (b29'=min(b29+1,L));
