...
[]s=4 -> 0.25 :(s'=4) + 0.3125 :(s'=5) + 0.1875 :(s'=6) + 0.25 :(s'=155);
[]s=5 -> 1.0 :(s'=6);
[]s=6 -> 0.26666666666666666 :(s'=6) + 0.7333333333333333 :(s'=7);
[]s=7 -> 0.7441860465116279 :(s'=7) + 0.23255813953488372 :(s'=8) + 0.023255813953488372 :(s'=10);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 1.0 :(s'=11);
[]s=10 -> 1.0 :(s'=12);
[]s=11 -> 1.0 :(s'=13);
...
[]s=71 -> 1.0 :(s'=73);
[]s=72 -> 1.0 :(s'=74);
[]s=73 -> 0.8333333333333334 :(s'=75) + 0.16666666666666666 :(s'=77);
[]s=74 -> 1.0 :(s'=76);
[]s=75 -> 1.0 :(s'=78);
[]s=76 -> 1.0 :(s'=79);
[]s=77 -> 1.0 :(s'=80);
[]s=78 -> 0.8 :(s'=81) + 0.2 :(s'=84);
[]s=79 -> 1.0 :(s'=82);
[]s=80 -> 1.0 :(s'=83);
[]s=81 -> 1.0 :(s'=85);
[]s=82 -> 1.0 :(s'=86);
