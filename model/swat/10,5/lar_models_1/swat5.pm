...
[]s=4 -> 0.7435897435897436 :(s'=4) + 0.2564102564102564 :(s'=139);
[]s=5 -> 1.0 :(s'=6);
[]s=6 -> 1.0 :(s'=7);
[]s=7 -> 1.0 :(s'=8);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 0.5 :(s'=11) + 0.5 :(s'=227);
[]s=10 -> 1.0 :(s'=12);
[]s=11 -> 1.0 :(s'=13);
[]s=12 -> 1.0 :(s'=15);
[]s=13 -> 1.0 :(s'=16);
...
[]s=137 -> 1.0 :(s'=140);
[]s=138 -> 1.0 :(s'=141);
[]s=139 -> 0.8 :(s'=142) + 0.2 :(s'=5);
[]s=140 -> 1.0 :(s'=143);
[]s=141 -> 1.0 :(s'=144);
[]s=142 -> 0.875 :(s'=145) + 0.125 :(s'=345);
[]s=143 -> 1.0 :(s'=146);
[]s=144 -> 1.0 :(s'=147);
[]s=145 -> 1.0 :(s'=148);
[]s=146 -> 1.0 :(s'=149);
...
[]s=149 -> 1.0 :(s'=152);
[]s=150 -> 1.0 :(s'=153);
[]s=151 -> 0.8571428571428571 :(s'=154) + 0.14285714285714285 :(s'=14);
[]s=152 -> 1.0 :(s'=155);
[]s=153 -> 1.0 :(s'=156);
[]s=154 -> 0.5 :(s'=157) + 0.5 :(s'=10);
[]s=155 -> 1.0 :(s'=158);
[]s=156 -> 1.0 :(s'=159);
[]s=157 -> 0.3333333333333333 :(s'=81) + 0.6666666666666666 :(s'=160);
[]s=158 -> 1.0 :(s'=161);
[]s=159 -> 1.0 :(s'=162);
[]s=160 -> 1.0 :(s'=163);
[]s=161 -> 1.0 :(s'=164);
