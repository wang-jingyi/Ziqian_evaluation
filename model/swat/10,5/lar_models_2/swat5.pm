...
s:[1..300] init 1; 
[]s=1 -> 1.0 :(s'=2);
[]s=2 -> 0.9994476968960565 :(s'=2) + 4.970727935490998E-4 :(s'=3) + 5.5230310394344414E-5 :(s'=175);
[]s=3 -> 0.71875 :(s'=3) + 0.28125 :(s'=4);
[]s=4 -> 0.6666666666666666 :(s'=4) + 0.3333333333333333 :(s'=5);
[]s=5 -> 0.9057971014492754 :(s'=5) + 0.050724637681159424 :(s'=296) + 0.043478260869565216 :(s'=87);
[]s=6 -> 1.0 :(s'=7);
[]s=7 -> 1.0 :(s'=8);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 1.0 :(s'=10);
[]s=10 -> 0.8 :(s'=11) + 0.2 :(s'=19);
[]s=11 -> 1.0 :(s'=12);
[]s=12 -> 1.0 :(s'=13);
[]s=13 -> 1.0 :(s'=14);
[]s=14 -> 0.75 :(s'=15) + 0.25 :(s'=90);
[]s=15 -> 1.0 :(s'=16);
[]s=16 -> 1.0 :(s'=17);
[]s=17 -> 1.0 :(s'=18);
[]s=18 -> 1.0 :(s'=20);
...
[]s=22 -> 1.0 :(s'=23);
[]s=23 -> 1.0 :(s'=24);
[]s=24 -> 0.6666666666666666 :(s'=25) + 0.3333333333333333 :(s'=30);
[]s=25 -> 1.0 :(s'=26);
[]s=26 -> 1.0 :(s'=27);
[]s=27 -> 1.0 :(s'=28);
[]s=28 -> 1.0 :(s'=29);
