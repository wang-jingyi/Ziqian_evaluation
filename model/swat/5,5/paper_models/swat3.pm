...
[]s=3 -> 0.01818181818181818 :(s'=2) + 0.8181818181818182 :(s'=3) + 0.16363636363636364 :(s'=4);
[]s=4 -> 1.0 :(s'=5);
[]s=5 -> 1.0 :(s'=6);
[]s=6 -> 0.125 :(s'=3) + 0.875 :(s'=7);
[]s=7 -> 0.8571428571428571 :(s'=8) + 0.14285714285714285 :(s'=10);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 1.0 :(s'=11);
[]s=10 -> 1.0 :(s'=12);
[]s=11 -> 1.0 :(s'=13);
...
label "underflow" = s=10|s=44|s=78|s=102;
