...
s:[1..287] init 1; 
[]s=1 -> 1.0 :(s'=2);
[]s=2 -> 0.9993746091307066 :(s'=2) + 5.73274963518866E-4 :(s'=3) + 5.211590577444236E-5 :(s'=207);
[]s=3 -> 0.7368421052631579 :(s'=3) + 0.2631578947368421 :(s'=4);
[]s=4 -> 0.7142857142857143 :(s'=4) + 0.2857142857142857 :(s'=5);
[]s=5 -> 0.9150326797385621 :(s'=5) + 0.026143790849673203 :(s'=91) + 0.006535947712418301 :(s'=6) + 0.0392156862745098 :(s'=144) + 0.013071895424836602 :(s'=9);
[]s=6 -> 1.0 :(s'=7);
[]s=7 -> 1.0 :(s'=8);
[]s=8 -> 1.0 :(s'=10);
[]s=9 -> 1.0 :(s'=11);
...
label "underflow" = s=19|s=29|s=39|s=47|s=54|s=62|s=86|s=99|s=114|s=129|s=144|s=181|s=191|s=201|s=220|s=246|s=249|s=256|s=258|s=282|s=287;
label "learned_predicate_0" = s=2|s=207|s=211|s=215|s=219;
label "learned_predicate_1" = s=2|s=3|s=207|s=211|s=215|s=219|s=222|s=224|s=226;
label "learned_predicate_2" = s=2|s=3|s=4|s=207|s=211|s=215|s=219|s=222|s=224|s=226|s=228|s=230|s=232;
label "learned_predicate_3" = s=2|s=3|s=4|s=5|s=91|s=106|s=144|s=207|s=211;
label "learned_predicate_4" = s=2|s=3|s=4|s=5|s=6|s=7|s=8|s=9|s=10|s=11|s=12|s=13|s=14|s=15|s=17|s=19|s=21|s=23|s=25|s=91|s=94|s=97|s=100|s=103|s=106|s=144|s=200|s=203|s=206|s=207|s=210|s=211|s=214|s=215|s=218|s=219|s=222|s=224|s=226|s=228;
label "learned_predicate_5" = s=2|s=3|s=4|s=5|s=6|s=7|s=9|s=11|s=13|s=15|s=91|s=94|s=97|s=106|s=144|s=200|s=207|s=211|s=215|s=219;
label "learned_predicate_6" = s=2|s=3|s=4|s=5|s=9|s=11|s=13|s=15|s=17|s=19|s=144;
