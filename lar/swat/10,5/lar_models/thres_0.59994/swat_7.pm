...
[]s=8 -> 0.7142857142857143 :(s'=9) + 0.2857142857142857 :(s'=80);
[]s=9 -> 1.0 :(s'=10);
[]s=10 -> 0.6 :(s'=13) + 0.2 :(s'=16) + 0.2 :(s'=11);
[]s=11 -> 1.0 :(s'=12);
[]s=12 -> 1.0 :(s'=14);
[]s=13 -> 0.3333333333333333 :(s'=56) + 0.6666666666666666 :(s'=15);
[]s=14 -> 1.0 :(s'=16);
[]s=15 -> 1.0 :(s'=17);
[]s=16 -> 1.0 :(s'=18);
[]s=17 -> 1.0 :(s'=19);
...
label "swat_error" = s=11|s=65|s=75|s=79|s=80|s=85|s=90|s=114;
...
label "learned_predicate_5" = s=3|s=4|s=5|s=6|s=7|s=8|s=9|s=10|s=11|s=12|s=13|s=56|s=58|s=60|s=62|s=64|s=66|s=80|s=81|s=82|s=83|s=84|s=85|s=86|s=87|s=88|s=89;
