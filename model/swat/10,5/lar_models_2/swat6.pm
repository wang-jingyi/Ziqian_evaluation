...
s:[1..340] init 1; 
[]s=1 -> 1.0 :(s'=2);
[]s=2 -> 0.9994476968960565 :(s'=2) + 4.970727935490998E-4 :(s'=3) + 5.5230310394344414E-5 :(s'=215);
[]s=3 -> 0.71875 :(s'=3) + 0.28125 :(s'=4);
[]s=4 -> 0.6666666666666666 :(s'=4) + 0.3333333333333333 :(s'=5);
[]s=5 -> 0.9057971014492754 :(s'=5) + 0.050724637681159424 :(s'=336) + 0.043478260869565216 :(s'=127);
[]s=6 -> 1.0 :(s'=7);
[]s=7 -> 1.0 :(s'=8);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 1.0 :(s'=10);
...
[]s=55 -> 1.0 :(s'=58);
[]s=56 -> 1.0 :(s'=59);
[]s=57 -> 0.6666666666666666 :(s'=60) + 0.3333333333333333 :(s'=16);
[]s=58 -> 1.0 :(s'=61);
[]s=59 -> 1.0 :(s'=62);
[]s=60 -> 0.5 :(s'=108) + 0.5 :(s'=63);
[]s=61 -> 1.0 :(s'=64);
[]s=62 -> 1.0 :(s'=65);
[]s=63 -> 1.0 :(s'=66);
[]s=64 -> 1.0 :(s'=67);
...
[]s=336 -> 1.0 :(s'=338);
[]s=337 -> 1.0 :(s'=339);
[]s=338 -> 0.5714285714285714 :(s'=340) + 0.42857142857142855 :(s'=6);
[]s=339 -> 1.0 :(s'=225);
[]s=340 -> 1.0 :(s'=57);
endmodule 
...
label "underflow" = s=24|s=35|s=40|s=45|s=50|s=104|s=118|s=127|s=130|s=145|s=206|s=218|s=224|s=238|s=255|s=262|s=277|s=302|s=319|s=329|s=332|s=339;
label "learned_predicate_0" = s=2|s=215;
label "learned_predicate_1" = s=2|s=3|s=215|s=219|s=223|s=227;
label "learned_predicate_2" = s=2|s=3|s=4|s=215|s=219|s=223|s=227|s=231|s=235|s=239;
label "learned_predicate_3" = s=2|s=3|s=4|s=5|s=127;
label "learned_predicate_4" = s=2|s=3|s=4|s=5|s=57|s=60|s=108|s=111|s=114|s=127|s=215|s=219|s=223|s=227|s=231|s=235|s=239|s=243|s=247|s=336|s=338|s=340;
