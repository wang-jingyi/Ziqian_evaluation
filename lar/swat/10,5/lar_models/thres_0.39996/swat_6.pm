...
[]s=7 -> 0.2 :(s'=75) + 0.8 :(s'=8);
[]s=8 -> 0.7272727272727273 :(s'=8) + 0.2727272727272727 :(s'=9);
[]s=9 -> 1.0 :(s'=10);
[]s=10 -> 1.0 :(s'=11);
[]s=11 -> 1.0 :(s'=12);
[]s=12 -> 0.9 :(s'=13) + 0.1 :(s'=14);
[]s=13 -> 0.9 :(s'=15) + 0.1 :(s'=187);
[]s=14 -> 1.0 :(s'=16);
[]s=15 -> 0.8888888888888888 :(s'=17) + 0.1111111111111111 :(s'=102);
[]s=16 -> 1.0 :(s'=18);
[]s=17 -> 1.0 :(s'=19);
[]s=18 -> 1.0 :(s'=20);
[]s=19 -> 1.0 :(s'=21);
[]s=20 -> 1.0 :(s'=22);
[]s=21 -> 0.8888888888888888 :(s'=23) + 0.1111111111111111 :(s'=324);
[]s=22 -> 1.0 :(s'=24);
[]s=23 -> 1.0 :(s'=25);
[]s=24 -> 1.0 :(s'=26);
[]s=25 -> 1.0 :(s'=27);
