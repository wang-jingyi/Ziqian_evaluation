...
s:[1..255] init 1; 
[]s=1 -> 1.0 :(s'=2);
[]s=2 -> 0.9993746743095362 :(s'=2) + 5.732152162584679E-4 :(s'=3) + 5.211047420531527E-5 :(s'=184);
[]s=3 -> 0.7368421052631579 :(s'=3) + 0.2631578947368421 :(s'=4);
[]s=4 -> 0.7142857142857143 :(s'=4) + 0.2857142857142857 :(s'=5);
[]s=5 -> 0.9235668789808917 :(s'=5) + 0.03821656050955414 :(s'=71) + 0.03821656050955414 :(s'=120);
[]s=6 -> 1.0 :(s'=7);
[]s=7 -> 1.0 :(s'=8);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 1.0 :(s'=10);
...
[]s=81 -> 1.0 :(s'=84);
[]s=82 -> 1.0 :(s'=85);
[]s=83 -> 0.8571428571428571 :(s'=86) + 0.14285714285714285 :(s'=6);
[]s=84 -> 1.0 :(s'=87);
[]s=85 -> 1.0 :(s'=88);
[]s=86 -> 1.0 :(s'=89);
[]s=87 -> 1.0 :(s'=90);
...
[]s=117 -> 1.0 :(s'=121);
[]s=118 -> 1.0 :(s'=122);
[]s=119 -> 0.8333333333333334 :(s'=123) + 0.16666666666666666 :(s'=17);
[]s=120 -> 1.0 :(s'=5);
[]s=121 -> 1.0 :(s'=124);
[]s=122 -> 1.0 :(s'=125);
[]s=123 -> 1.0 :(s'=126);
...
label "underflow" = s=6|s=11|s=17|s=25|s=32|s=40|s=64|s=76|s=90|s=105|s=120|s=157|s=167|s=176|s=188|s=214|s=217|s=224|s=226|s=250|s=255;
label "learned_predicate_0" = s=2|s=184|s=187;
label "learned_predicate_1" = s=2|s=3|s=184|s=187|s=190|s=192|s=194;
label "learned_predicate_2" = s=2|s=3|s=4|s=184|s=187|s=190|s=192|s=194|s=196|s=198|s=200;
label "learned_predicate_3" = s=2|s=3|s=4|s=5|s=120;
