...
[]s=180 -> 1.0 :(s'=185);
[]s=181 -> 1.0 :(s'=186);
[]s=182 -> 0.55 :(s'=958) + 0.4 :(s'=187) + 0.05 :(s'=425);
[]s=183 -> 1.0 :(s'=188);
[]s=184 -> 1.0 :(s'=189);
[]s=185 -> 1.0 :(s'=190);
[]s=186 -> 1.0 :(s'=191);
...
[]s=871 -> 1.0 :(s'=878);
[]s=872 -> 1.0 :(s'=879);
[]s=873 -> 0.6666666666666666 :(s'=880) + 0.3333333333333333 :(s'=1794);
[]s=874 -> 1.0 :(s'=881);
[]s=875 -> 1.0 :(s'=882);
[]s=876 -> 1.0 :(s'=883);
[]s=877 -> 1.0 :(s'=884);
...
[]s=956 -> 1.0 :(s'=966);
[]s=957 -> 1.0 :(s'=967);
[]s=958 -> 0.6363636363636364 :(s'=968) + 0.36363636363636365 :(s'=2413);
[]s=959 -> 1.0 :(s'=969);
[]s=960 -> 1.0 :(s'=970);
[]s=961 -> 1.0 :(s'=971);
[]s=962 -> 1.0 :(s'=972);
...
[]s=966 -> 1.0 :(s'=976);
[]s=967 -> 1.0 :(s'=977);
[]s=968 -> 0.5714285714285714 :(s'=978) + 0.42857142857142855 :(s'=866);
[]s=969 -> 1.0 :(s'=979);
[]s=970 -> 1.0 :(s'=980);
[]s=971 -> 1.0 :(s'=981);
[]s=972 -> 1.0 :(s'=982);
...
[]s=1037 -> 1.0 :(s'=1048);
[]s=1038 -> 1.0 :(s'=1049);
[]s=1039 -> 0.3333333333333333 :(s'=2305) + 0.6666666666666666 :(s'=1050);
[]s=1040 -> 1.0 :(s'=1051);
[]s=1041 -> 1.0 :(s'=1052);
[]s=1042 -> 1.0 :(s'=1053);
[]s=1043 -> 1.0 :(s'=1054);
...
[]s=2411 -> 1.0 :(s'=2416);
[]s=2412 -> 1.0 :(s'=2417);
[]s=2413 -> 0.5 :(s'=2418) + 0.5 :(s'=106);
[]s=2414 -> 1.0 :(s'=2419);
[]s=2415 -> 1.0 :(s'=2420);
[]s=2416 -> 1.0 :(s'=2421);
[]s=2417 -> 1.0 :(s'=2422);
[]s=2418 -> 0.5 :(s'=2423) + 0.5 :(s'=1038);
[]s=2419 -> 1.0 :(s'=2424);
[]s=2420 -> 1.0 :(s'=2425);
[]s=2421 -> 1.0 :(s'=2426);
[]s=2422 -> 1.0 :(s'=2427);
