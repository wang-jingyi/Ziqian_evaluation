...
s:[1..275] init 1; 
[]s=1 -> 1.0 :(s'=2);
[]s=2 -> 0.9993746743095362 :(s'=2) + 5.732152162584679E-4 :(s'=3) + 5.211047420531527E-5 :(s'=203);
[]s=3 -> 0.7368421052631579 :(s'=3) + 0.2631578947368421 :(s'=4);
[]s=4 -> 0.7142857142857143 :(s'=4) + 0.2857142857142857 :(s'=5);
[]s=5 -> 0.9235668789808917 :(s'=5) + 0.03821656050955414 :(s'=87) + 0.03821656050955414 :(s'=136);
[]s=6 -> 1.0 :(s'=8);
[]s=7 -> 1.0 :(s'=9);
[]s=8 -> 1.0 :(s'=10);
[]s=9 -> 1.0 :(s'=11);
[]s=10 -> 1.0 :(s'=12);
[]s=11 -> 0.5 :(s'=196) + 0.5 :(s'=13);
[]s=12 -> 1.0 :(s'=14);
[]s=13 -> 1.0 :(s'=15);
[]s=14 -> 1.0 :(s'=16);
[]s=15 -> 1.0 :(s'=17);
...
[]s=88 -> 1.0 :(s'=91);
[]s=89 -> 1.0 :(s'=92);
[]s=90 -> 0.3333333333333333 :(s'=7) + 0.6666666666666666 :(s'=93);
[]s=91 -> 1.0 :(s'=94);
[]s=92 -> 1.0 :(s'=95);
[]s=93 -> 1.0 :(s'=96);
[]s=94 -> 1.0 :(s'=97);
[]s=95 -> 1.0 :(s'=98);
[]s=96 -> 0.25 :(s'=6) + 0.75 :(s'=99);
[]s=97 -> 1.0 :(s'=100);
[]s=98 -> 1.0 :(s'=101);
[]s=99 -> 1.0 :(s'=102);
[]s=100 -> 1.0 :(s'=103);
