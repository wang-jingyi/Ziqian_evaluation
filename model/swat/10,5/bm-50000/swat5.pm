...
[]s=64 -> 1.0 :(s'=68);
[]s=65 -> 1.0 :(s'=69);
[]s=66 -> 0.9523809523809523 :(s'=174) + 0.047619047619047616 :(s'=70);
[]s=67 -> 1.0 :(s'=71);
[]s=68 -> 1.0 :(s'=72);
[]s=69 -> 1.0 :(s'=73);
[]s=70 -> 1.0 :(s'=74);
...
[]s=172 -> 1.0 :(s'=177);
[]s=173 -> 1.0 :(s'=178);
[]s=174 -> 0.55 :(s'=942) + 0.4 :(s'=179) + 0.05 :(s'=417);
[]s=175 -> 1.0 :(s'=180);
[]s=176 -> 1.0 :(s'=181);
[]s=177 -> 1.0 :(s'=182);
[]s=178 -> 1.0 :(s'=183);
[]s=179 -> 0.75 :(s'=184) + 0.25 :(s'=12);
[]s=180 -> 1.0 :(s'=185);
[]s=181 -> 1.0 :(s'=186);
[]s=182 -> 1.0 :(s'=187);
[]s=183 -> 1.0 :(s'=188);
[]s=184 -> 0.6666666666666666 :(s'=189) + 0.3333333333333333 :(s'=199);
[]s=185 -> 1.0 :(s'=190);
[]s=186 -> 1.0 :(s'=191);
[]s=187 -> 1.0 :(s'=192);
[]s=188 -> 1.0 :(s'=193);
[]s=189 -> 0.25 :(s'=720) + 0.75 :(s'=194);
[]s=190 -> 1.0 :(s'=195);
[]s=191 -> 1.0 :(s'=196);
[]s=192 -> 1.0 :(s'=197);
[]s=193 -> 1.0 :(s'=198);
[]s=194 -> 0.6666666666666666 :(s'=200) + 0.3333333333333333 :(s'=328);
[]s=195 -> 1.0 :(s'=201);
[]s=196 -> 1.0 :(s'=202);
[]s=197 -> 1.0 :(s'=203);
[]s=198 -> 1.0 :(s'=204);
[]s=199 -> 1.0 :(s'=205);
[]s=200 -> 0.5 :(s'=206) + 0.5 :(s'=703);
[]s=201 -> 1.0 :(s'=207);
[]s=202 -> 1.0 :(s'=208);
[]s=203 -> 1.0 :(s'=209);
[]s=204 -> 1.0 :(s'=210);
...
[]s=863 -> 1.0 :(s'=870);
[]s=864 -> 1.0 :(s'=871);
[]s=865 -> 0.6666666666666666 :(s'=872) + 0.3333333333333333 :(s'=1047);
[]s=866 -> 1.0 :(s'=873);
[]s=867 -> 1.0 :(s'=874);
[]s=868 -> 1.0 :(s'=875);
[]s=869 -> 1.0 :(s'=876);
...
[]s=940 -> 1.0 :(s'=948);
[]s=941 -> 1.0 :(s'=949);
[]s=942 -> 0.6363636363636364 :(s'=950) + 0.36363636363636365 :(s'=2298);
[]s=943 -> 1.0 :(s'=951);
[]s=944 -> 1.0 :(s'=952);
[]s=945 -> 1.0 :(s'=953);
[]s=946 -> 1.0 :(s'=954);
...
[]s=948 -> 1.0 :(s'=956);
[]s=949 -> 1.0 :(s'=957);
[]s=950 -> 0.5714285714285714 :(s'=958) + 0.42857142857142855 :(s'=858);
[]s=951 -> 1.0 :(s'=959);
[]s=952 -> 1.0 :(s'=960);
[]s=953 -> 1.0 :(s'=961);
[]s=954 -> 1.0 :(s'=962);
...
[]s=1038 -> 1.0 :(s'=1046);
[]s=1039 -> 1.0 :(s'=1047);
[]s=1040 -> 0.8333333333333334 :(s'=1048) + 0.16666666666666666 :(s'=1292);
[]s=1041 -> 1.0 :(s'=1049);
[]s=1042 -> 1.0 :(s'=1050);
[]s=1043 -> 1.0 :(s'=1051);
[]s=1044 -> 1.0 :(s'=1052);
...
[]s=2296 -> 1.0 :(s'=2301);
[]s=2297 -> 1.0 :(s'=2302);
[]s=2298 -> 0.5 :(s'=2303) + 0.5 :(s'=1241);
[]s=2299 -> 1.0 :(s'=2304);
[]s=2300 -> 1.0 :(s'=2305);
[]s=2301 -> 1.0 :(s'=2306);
[]s=2302 -> 1.0 :(s'=2307);
[]s=2303 -> 0.6666666666666666 :(s'=2308) + 0.3333333333333333 :(s'=1233);
[]s=2304 -> 1.0 :(s'=2309);
[]s=2305 -> 1.0 :(s'=2310);
[]s=2306 -> 1.0 :(s'=2311);
[]s=2307 -> 1.0 :(s'=2312);
