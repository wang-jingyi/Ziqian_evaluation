...
[]s=7 -> 0.022727272727272728 :(s'=6) + 0.7727272727272727 :(s'=7) + 0.20454545454545456 :(s'=8);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 1.0 :(s'=10);
[]s=10 -> 0.875 :(s'=11) + 0.125 :(s'=15);
[]s=11 -> 1.0 :(s'=12);
[]s=12 -> 1.0 :(s'=13);
[]s=13 -> 1.0 :(s'=14);
[]s=14 -> 1.0 :(s'=16);
...
[]s=24 -> 1.0 :(s'=26);
[]s=25 -> 1.0 :(s'=27);
[]s=26 -> 0.8333333333333334 :(s'=213) + 0.16666666666666666 :(s'=28);
[]s=27 -> 1.0 :(s'=29);
[]s=28 -> 1.0 :(s'=30);
[]s=29 -> 1.0 :(s'=31);
[]s=30 -> 1.0 :(s'=32);
