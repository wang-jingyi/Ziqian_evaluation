...
s:[1..421] init 1; 
[]s=1 -> 1.0 :(s'=2);
[]s=2 -> 0.9994760557476684 :(s'=2) + 4.7154982709839675E-4 :(s'=3) + 5.239442523315519E-5 :(s'=289);
[]s=3 -> 0.7272727272727273 :(s'=3) + 0.2727272727272727 :(s'=4);
[]s=4 -> 0.6666666666666666 :(s'=4) + 0.3333333333333333 :(s'=5);
[]s=5 -> 0.9213483146067416 :(s'=5) + 0.0449438202247191 :(s'=83) + 0.033707865168539325 :(s'=148);
[]s=6 -> 1.0 :(s'=7);
[]s=7 -> 1.0 :(s'=8);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 1.0 :(s'=10);
...
[]s=109 -> 1.0 :(s'=113);
[]s=110 -> 1.0 :(s'=114);
[]s=111 -> 0.8571428571428571 :(s'=115) + 0.14285714285714285 :(s'=152);
[]s=112 -> 1.0 :(s'=116);
[]s=113 -> 1.0 :(s'=117);
[]s=114 -> 1.0 :(s'=118);
[]s=115 -> 1.0 :(s'=119);
...
[]s=129 -> 1.0 :(s'=133);
[]s=130 -> 1.0 :(s'=134);
[]s=131 -> 0.8333333333333334 :(s'=135) + 0.16666666666666666 :(s'=323);
[]s=132 -> 1.0 :(s'=136);
[]s=133 -> 1.0 :(s'=137);
[]s=134 -> 1.0 :(s'=138);
[]s=135 -> 1.0 :(s'=139);
...
label "underflow" = s=6|s=11|s=16|s=22|s=29|s=37|s=72|s=89|s=108|s=118|s=128|s=138|s=148|s=152|s=177|s=220|s=245|s=269|s=281|s=296|s=299|s=310|s=323|s=327|s=350|s=353|s=366|s=372|s=388|s=393|s=401|s=421;
label "learned_predicate_0" = s=2|s=289|s=295;
label "learned_predicate_1" = s=2|s=3|s=289|s=295|s=301|s=307|s=313;
label "learned_predicate_2" = s=2|s=3|s=4|s=289|s=295|s=301|s=307|s=313|s=318|s=324|s=330;
label "learned_predicate_3" = s=2|s=3|s=4|s=5|s=148;
