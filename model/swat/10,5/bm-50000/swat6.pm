...
[]s=180 -> 1.0 :(s'=185);
[]s=181 -> 1.0 :(s'=186);
[]s=182 -> 0.55 :(s'=950) + 0.4 :(s'=187) + 0.05 :(s'=425);
[]s=183 -> 1.0 :(s'=188);
[]s=184 -> 1.0 :(s'=189);
[]s=185 -> 1.0 :(s'=190);
[]s=186 -> 1.0 :(s'=191);
...
[]s=871 -> 1.0 :(s'=878);
[]s=872 -> 1.0 :(s'=879);
[]s=873 -> 0.6666666666666666 :(s'=880) + 0.3333333333333333 :(s'=1757);
[]s=874 -> 1.0 :(s'=881);
[]s=875 -> 1.0 :(s'=882);
[]s=876 -> 1.0 :(s'=883);
[]s=877 -> 1.0 :(s'=884);
...
[]s=948 -> 1.0 :(s'=957);
[]s=949 -> 1.0 :(s'=958);
[]s=950 -> 0.6363636363636364 :(s'=959) + 0.36363636363636365 :(s'=2373);
[]s=951 -> 1.0 :(s'=960);
[]s=952 -> 1.0 :(s'=961);
[]s=953 -> 1.0 :(s'=962);
[]s=954 -> 1.0 :(s'=963);
...
[]s=957 -> 1.0 :(s'=966);
[]s=958 -> 1.0 :(s'=967);
[]s=959 -> 0.5714285714285714 :(s'=968) + 0.42857142857142855 :(s'=866);
[]s=960 -> 1.0 :(s'=969);
[]s=961 -> 1.0 :(s'=970);
[]s=962 -> 1.0 :(s'=971);
[]s=963 -> 1.0 :(s'=972);
...
[]s=1051 -> 1.0 :(s'=1061);
[]s=1052 -> 1.0 :(s'=1062);
[]s=1053 -> 0.3333333333333333 :(s'=2283) + 0.6666666666666666 :(s'=1063);
[]s=1054 -> 1.0 :(s'=1064);
[]s=1055 -> 1.0 :(s'=1065);
[]s=1056 -> 1.0 :(s'=1066);
[]s=1057 -> 1.0 :(s'=1067);
...
[]s=2371 -> 1.0 :(s'=2376);
[]s=2372 -> 1.0 :(s'=2377);
[]s=2373 -> 0.5 :(s'=2378) + 0.5 :(s'=106);
[]s=2374 -> 1.0 :(s'=2379);
[]s=2375 -> 1.0 :(s'=2380);
[]s=2376 -> 1.0 :(s'=2381);
[]s=2377 -> 1.0 :(s'=2382);
[]s=2378 -> 0.5 :(s'=2383) + 0.5 :(s'=1022);
[]s=2379 -> 1.0 :(s'=2384);
[]s=2380 -> 1.0 :(s'=2385);
[]s=2381 -> 1.0 :(s'=2386);
[]s=2382 -> 1.0 :(s'=2387);
