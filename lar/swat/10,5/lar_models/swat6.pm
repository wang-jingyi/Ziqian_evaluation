...
s:[1..459] init 1; 
[]s=1 -> 1.0 :(s'=2);
[]s=2 -> 0.9994760557476684 :(s'=2) + 4.7154982709839675E-4 :(s'=3) + 5.239442523315519E-5 :(s'=331);
[]s=3 -> 0.7272727272727273 :(s'=3) + 0.2727272727272727 :(s'=4);
[]s=4 -> 0.6666666666666666 :(s'=4) + 0.3333333333333333 :(s'=5);
[]s=5 -> 0.9213483146067416 :(s'=5) + 0.0449438202247191 :(s'=120) + 0.033707865168539325 :(s'=190);
[]s=6 -> 1.0 :(s'=7);
[]s=7 -> 1.0 :(s'=8);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 1.0 :(s'=10);
...
[]s=126 -> 1.0 :(s'=130);
[]s=127 -> 1.0 :(s'=131);
[]s=128 -> 0.75 :(s'=132) + 0.25 :(s'=13);
[]s=129 -> 1.0 :(s'=133);
[]s=130 -> 1.0 :(s'=134);
[]s=131 -> 1.0 :(s'=135);
[]s=132 -> 0.8333333333333334 :(s'=137) + 0.16666666666666666 :(s'=6);
[]s=133 -> 1.0 :(s'=138);
[]s=134 -> 1.0 :(s'=139);
[]s=135 -> 1.0 :(s'=140);
[]s=136 -> 1.0 :(s'=141);
[]s=137 -> 0.8 :(s'=142) + 0.2 :(s'=22);
[]s=138 -> 1.0 :(s'=143);
[]s=139 -> 1.0 :(s'=144);
[]s=140 -> 1.0 :(s'=145);
[]s=141 -> 1.0 :(s'=146);
[]s=142 -> 0.5 :(s'=147) + 0.5 :(s'=444);
[]s=143 -> 1.0 :(s'=148);
[]s=144 -> 1.0 :(s'=149);
[]s=145 -> 1.0 :(s'=150);
[]s=146 -> 0.8888888888888888 :(s'=151) + 0.1111111111111111 :(s'=363);
[]s=147 -> 0.5 :(s'=188) + 0.5 :(s'=152);
[]s=148 -> 1.0 :(s'=153);
[]s=149 -> 1.0 :(s'=154);
[]s=150 -> 1.0 :(s'=155);
[]s=151 -> 1:(s'=151);
