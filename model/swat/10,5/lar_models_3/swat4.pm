...
[]s=4 -> 0.8205128205128205 :(s'=4) + 0.15384615384615385 :(s'=5) + 0.02564102564102564 :(s'=85);
[]s=5 -> 0.8 :(s'=6) + 0.2 :(s'=87);
[]s=6 -> 1.0 :(s'=7);
[]s=7 -> 1.0 :(s'=8);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 1.0 :(s'=10);
...
[]s=11 -> 1.0 :(s'=12);
[]s=12 -> 1.0 :(s'=13);
[]s=13 -> 0.75 :(s'=14) + 0.25 :(s'=86);
[]s=14 -> 0.6666666666666666 :(s'=15) + 0.3333333333333333 :(s'=22);
[]s=15 -> 1.0 :(s'=16);
[]s=16 -> 1.0 :(s'=17);
[]s=17 -> 1.0 :(s'=18);
[]s=18 -> 0.3333333333333333 :(s'=28) + 0.6666666666666666 :(s'=19);
[]s=19 -> 1.0 :(s'=20);
[]s=20 -> 1.0 :(s'=21);
[]s=21 -> 1.0 :(s'=23);
[]s=22 -> 1.0 :(s'=24);
...
label "underflow" = s=19|s=22|s=31|s=38|s=48|s=79|s=85|s=86|s=87|s=96|s=97|s=121;
label "learned_predicate_0" = s=2;
label "learned_predicate_1" = s=2|s=3;
label "learned_predicate_2" = s=2|s=3|s=4|s=79|s=85;
