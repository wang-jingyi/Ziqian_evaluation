...
[]s=5 -> 1.0 :(s'=6);
[]s=6 -> 1.0 :(s'=7);
[]s=7 -> 0.9565217391304348 :(s'=30) + 0.043478260869565216 :(s'=8);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 1.0 :(s'=10);
[]s=10 -> 1.0 :(s'=11);
[]s=11 -> 1.0 :(s'=12);
...
[]s=30 -> 1.0 :(s'=32);
[]s=31 -> 1.0 :(s'=33);
[]s=32 -> 0.9545454545454546 :(s'=34) + 0.045454545454545456 :(s'=203);
[]s=33 -> 1.0 :(s'=35);
[]s=34 -> 0.9523809523809523 :(s'=36) + 0.047619047619047616 :(s'=500);
[]s=35 -> 1.0 :(s'=37);
[]s=36 -> 1.0 :(s'=38);
[]s=37 -> 1.0 :(s'=39);
[]s=38 -> 1.0 :(s'=40);
...
[]s=202 -> 1.0 :(s'=207);
[]s=203 -> 1.0 :(s'=208);
[]s=204 -> 0.9473684210526315 :(s'=209) + 0.05263157894736842 :(s'=384);
[]s=205 -> 1.0 :(s'=210);
[]s=206 -> 1.0 :(s'=211);
[]s=207 -> 1.0 :(s'=212);
[]s=208 -> 1.0 :(s'=213);
...
[]s=242 -> 1.0 :(s'=247);
[]s=243 -> 1.0 :(s'=248);
[]s=244 -> 0.9375 :(s'=249) + 0.0625 :(s'=56);
[]s=245 -> 1.0 :(s'=250);
[]s=246 -> 1.0 :(s'=251);
[]s=247 -> 1.0 :(s'=252);
[]s=248 -> 1.0 :(s'=253);
...
[]s=252 -> 1.0 :(s'=257);
[]s=253 -> 1.0 :(s'=258);
[]s=254 -> 0.9333333333333333 :(s'=259) + 0.06666666666666667 :(s'=62);
[]s=255 -> 1.0 :(s'=260);
[]s=256 -> 1.0 :(s'=261);
[]s=257 -> 1.0 :(s'=262);
[]s=258 -> 1.0 :(s'=263);
...
[]s=316 -> 1.0 :(s'=320);
[]s=317 -> 1.0 :(s'=321);
[]s=318 -> 0.9166666666666666 :(s'=322) + 0.08333333333333333 :(s'=912);
[]s=319 -> 1.0 :(s'=323);
[]s=320 -> 1.0 :(s'=324);
[]s=321 -> 1.0 :(s'=325);
[]s=322 -> 1.0 :(s'=326);
...
[]s=380 -> 1.0 :(s'=383);
[]s=381 -> 1.0 :(s'=385);
[]s=382 -> 0.9090909090909091 :(s'=386) + 0.09090909090909091 :(s'=1008);
[]s=383 -> 1.0 :(s'=387);
[]s=384 -> 1.0 :(s'=388);
[]s=385 -> 1.0 :(s'=389);
[]s=386 -> 1.0 :(s'=390);
...
[]s=518 -> 1.0 :(s'=523);
[]s=519 -> 1.0 :(s'=524);
[]s=520 -> 0.8333333333333334 :(s'=525) + 0.16666666666666666 :(s'=1557);
[]s=521 -> 1.0 :(s'=526);
[]s=522 -> 1.0 :(s'=527);
[]s=523 -> 1.0 :(s'=528);
[]s=524 -> 1.0 :(s'=529);
...
[]s=663 -> 1.0 :(s'=668);
[]s=664 -> 1.0 :(s'=669);
[]s=665 -> 0.6666666666666666 :(s'=1470) + 0.3333333333333333 :(s'=670);
[]s=666 -> 1.0 :(s'=671);
[]s=667 -> 1.0 :(s'=672);
[]s=668 -> 1.0 :(s'=673);
[]s=669 -> 1.0 :(s'=674);
