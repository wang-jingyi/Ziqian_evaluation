...
[]s=4 -> 0.7435897435897436 :(s'=4) + 0.2564102564102564 :(s'=72);
[]s=5 -> 1.0 :(s'=6);
[]s=6 -> 1.0 :(s'=7);
[]s=7 -> 1.0 :(s'=8);
[]s=8 -> 1.0 :(s'=9);
[]s=9 -> 0.5 :(s'=10) + 0.5 :(s'=160);
[]s=10 -> 1.0 :(s'=11);
[]s=11 -> 1.0 :(s'=12);
[]s=12 -> 1.0 :(s'=13);
[]s=13 -> 1.0 :(s'=14);
...
[]s=70 -> 1.0 :(s'=73);
[]s=71 -> 1.0 :(s'=74);
[]s=72 -> 0.8 :(s'=75) + 0.2 :(s'=5);
[]s=73 -> 1.0 :(s'=76);
[]s=74 -> 1.0 :(s'=77);
[]s=75 -> 0.875 :(s'=78) + 0.125 :(s'=298);
[]s=76 -> 1.0 :(s'=79);
[]s=77 -> 1.0 :(s'=80);
[]s=78 -> 1.0 :(s'=81);
[]s=79 -> 1.0 :(s'=82);
...
[]s=136 -> 1.0 :(s'=139);
[]s=137 -> 1.0 :(s'=140);
[]s=138 -> 0.8333333333333334 :(s'=141) + 0.16666666666666666 :(s'=59);
[]s=139 -> 1.0 :(s'=142);
[]s=140 -> 1.0 :(s'=143);
[]s=141 -> 1.0 :(s'=144);
[]s=142 -> 1.0 :(s'=145);
